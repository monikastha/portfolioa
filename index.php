...
<body>
    ...
    <nav>
        <ul>
            ...
            <li><a href="#about" class="nav_link">Gallery</a></li>
    ...
    <div class="gallery-container">
        <div class="gallery-item">
            <img src="public/pexels-photo-1988681.jpeg" alt="Gallery Image 1">
        </div>
        <div class="gallery-item">
            <img src="public/pexels-photo-3094218.jpeg" alt="Gallery Image 2">
        </div>
        <div class="gallery-item">
            <img src="public/pexels-photo-3299386.jpeg" alt="Gallery Image 3">
        </div>
        <div class="gallery-item">
            <img src="public/pexels-photo-1988681.jpeg" alt="Gallery Image 1">
        </div>
